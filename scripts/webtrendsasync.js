...
function WebtrendsAsync(){
	...
	this.dcsid="dcsdh2kqe10000s5jgntfhyvf_2b6u";
...
WebtrendsAsync.prototype.dcsJavaScript = function(evt) {
    evt = evt || (window.event || "");
    if (evt && ((typeof (evt.which) != "number") || (evt.which == 1))) {
        var e = this.dcsEvt(evt, "A");
        if (e.href && e.protocol) {
...
WebtrendsAsync.prototype.dcsFormButton=function(evt){
	evt=evt||(window.event||"");
	if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
...
WebtrendsAsync.prototype.dcsImageMap=function(evt){
	evt=evt||(window.event||"");
	if (evt){
